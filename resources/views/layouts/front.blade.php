...
<div class="page-wrapper">
    ...
    <header class="main-header">
        ...
        <div class="header-top">
            <div class="auto-container clearfix">
                <div class="top-left clearfix">
                    <ul class="list">
						<li><span class="icon fas fa-envelope"></span> 9853 Omar El Mukhtar Street  Gaza  94117-1080 PS</li>
						<li><span class="icon fas fa-phone"></span> <a href="{{asset('assets/tel:+555–123–2323') }}"> 00972</a></li>
					</ul>
                </div>
            ...
            <div class="inner-container">
                <div class="auto-container clearfix">
                    ...
                    <div class="logo-outer">
                        <div class="logo"><a href="index.html"><img src="{{asset('assets/images/pal_news.jpg') }}" alt="" title=""></a></div>
                    </div>
                    ...
                    <div class="nav-outer clearfix">
                        ...
                        <div class="outer-box clearfix">
                            ...
                            <!-- Button Box -->
                            <div class="btn-box">
                                <a href="{{route('posts.index')}}" class="theme-btn btn-style-one"><span class="txt">Palestine News</span></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="sticky-header">
        	<div class="auto-container clearfix">
            	...
            	<div class="logo pull-left">
                	<a href="index.html" class="img-responsive"><img src="{{asset('assets/images/pal.jpg') }}" alt="" title=""></a>
                </div>
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
            	<div class="nav-logo"><a href="index.html"><img src="{{asset('assets/images/nav-logo.png') }}" alt="" title=""></a></div>
                                ...
                                <div class="footer-widget news-widget">
                                    ...
                                    <div class="news-widget-block">
                                        <div class="widget-inner">
                                            <div class="image">
                                                <img src="{{asset('assets/images/resource/news-image-1.jpg') }}" alt="" />
                                            </div>
